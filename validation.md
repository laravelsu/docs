...
> [!WARNING]
> По умолчанию скелет приложения Laravel не включает каталог `lang`. Если вы хотите настроить языковые файлы Laravel, вы можете опубликовать их с помощью Artisan-команды `lang:publish`.
