...
Методы `afterToday` и `todayOrAfter` можно использовать для беглого выражения того, что дата должна быть после сегодняшнего дня или или сегодня или после, соответственно:
...
Методы `beforeToday` и `todayOrBefore` можно использовать для беглого выражения того, что дата должна быть до сегодняшнего дня или или сегодня или до, соответственно:
