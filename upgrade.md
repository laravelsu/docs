---
git: dd1d7bfc3f534716b7935d0a1fdfaf15decca9d9
---
...
Мы также рекомендуем просмотреть изменения в [GitHub-репозитории](https://github.com/laravel/laravel) `laravel/laravel`. Хотя многие из этих изменений не обязательны, возможно, вы захотите синхронизировать эти файлы с вашим приложением. Некоторые изменения будут описаны в этом руководстве по обновлению, но другие, например изменения файлов конфигурации или комментариев, не будут. Вы можете легко посмотреть изменения с помощью [инструмента сравнения GitHub](https://github.com/laravel/laravel/compare/12.x...13.x) и выбрать, какие обновления важны для вас.
