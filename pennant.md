---
git: 91d40eed458358041c4e18d25b275e941e91ff9d
---
...
По умолчанию Pennant будет хранить полное имя класса функции. Если вы хотите отделить хранимое имя функции от внутренней структуры приложения, вы можете добавить атрибут `Name` к классу функции. Значение этого атрибута будет храниться вместо имени класса:
