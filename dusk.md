...
Утверждает, что элементы, соответствующие данному селектору, появляются указанное количество раз:
...
Утверждает, что элементу с указанным селектором, не хватает переданного атрибута:
...
Метод `component` может использоваться для получения экземпляра браузера, ограниченного указанным компонентом:
