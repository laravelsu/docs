...
> [!WARNING]
> При использовании драйвера загрузки Redis ваша установка Pulse должна всегда использовать другое соединение Redis, чем ваша очередь, работающая на основе Redis, если это применимо.
