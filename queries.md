...
> [!NOTE]
> Условия векторного сходства поддерживаются для соединений PostgreSQL с расширением `pgvector`, а также MariaDB 11.7 и новее. Информацию об определении векторных столбцов и индексов см. в [документации по миграциям](/docs/{{version}}/migrations#available-column-types).
