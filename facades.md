---
git: a52b24e4db49e6962e06e88babc55f832e9d4a40
---
...
В дополнение к фасадам Laravel предлагает множество глобальных вспомогательных функций, упрощающих работу с распространенными возможностями фреймворка, например `view`, `response`, `url` и `config`. Каждая такая функция документирована вместе с соответствующей возможностью, а полный список доступен в отдельной [документации по вспомогательным функциям](/docs/{{version}}/helpers).
