---
git: fdf1d85a032b220060cc246bd3ed643259197903
---
...
Если вы хотите отсортировать свою коллекцию по нескольким атрибутам, вы можете передать массив атрибутов, по которым вы хотите отсортировать:
...
При сортировке по нескольким атрибутам и направлениям вы можете передать массив операций сортировки методу `sortBy`. Каждая операция сортировки должна быть массивом, состоящим из атрибута, по которому вы хотите выполнить сортировку, и направления желаемой сортировки:
