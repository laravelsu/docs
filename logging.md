---
git: d772dd9cf0f7650c27430640bfcdc2d112be8f2f
---
...
| ------ | ----------------------------------------------------------------------- | ------- |
| `days` | Количество дней, в течение которых следует хранить файлы канала daily.  | `14`    |
...
Laravel Pail - это пакет, который позволяет вам легко погружаться в лог-файлы вашего приложения Laravel прямо из командной строки. В отличие от стандартной команды `tail`, Pail предназначен для работы с любым драйвером журналов, включая [Laravel Nightwatch](https://nightwatch.laravel.com), Sentry или Flare. Кроме того, Pail предоставляет набор полезных фильтров, которые помогут вам быстро найти то, что вы ищете.
